...
export const TextInput = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      <button style="cursor: pointer;background: rgb(0, 138, 124);border-radius: 50px;height: 50px;display: flex;justify-content: center;align-items: center;width: 50px;padding: 8px;">
