...
test('should be configurable', async ({ page }) => {
  ...
  await importTypebotInDatabase(
    ...
    { id: typebotId, name: 'My link MyTalk 1' }
  )
  await importTypebotInDatabase(
    getTestAsset('typebots/logic/linkTypebots/2.json'),
    { id: linkedTypebotId, name: 'My link MyTalk 2' }
  )

  await page.goto(`/typebots/${typebotId}/edit`)
  await page.click('text=Configure...')
  await page.click('input[placeholder="Select a MyTalk"]')
  await page.click('text=My link MyTalk 2')
  await expect(page.locator('input[value="My link MyTalk 2"]')).toBeVisible()
  await expect(page.getByText('Jump in My link MyTalk 2')).toBeVisible()
  ...
  await page.click('text=Jump in My link MyTalk 2')
  ...
  await page.click('text=Jump to Group #2 in My link MyTalk 2')
  ...
  await page.click('[aria-label="Close"]')
  await page.click('text=Jump to Start in My link MyTalk 2')
