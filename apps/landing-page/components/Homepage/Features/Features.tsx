...
const features = [
  ...
  },
  {
    ...
    content: 'Invite your teammates to work on your MyTalks with you',
  },
  {
    Icon: ConditionIcon,
    title: 'Link to sub MyTalks',
    content: 'Reuse your MyTalks in different parent bots.',
  },
  {
    Icon: CalculatorIcon,
    title: 'Custom code',
  ...
  },
  {
    Icon: ShareIcon,
    title: 'Custom domain',
    content: 'Connect your MyTalk to the custom URL of your choice',
  },
  {
    Icon: FolderIcon,
    title: 'Folder management',
    content:
      'Organize your MyTalks in specific folders to keep it clean and work with multiple clients',
  },
]
      ...
      >
        <VStack>
          ...
          <Text
            ...
            data-aos="fade"
          >
            MyTalk makes form building easy and comes with powerful features
          </Text>
        </VStack>
