...
Variables are placeholders for content that you can then use anywhere in the MyTalk. It's a very important concept to understand to truly create a customized experience for the user.
...
Let's say My talk contains these variables:
